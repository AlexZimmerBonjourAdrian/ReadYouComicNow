...
export default function Home() {
  ...
  const openFiles = async (files: File[], persist = true) => {
    ...
    if (!valid.length) {
      setError('Sube un CBZ, PDF, EPUB o imágenes (JPG/PNG/WebP).');
      return;
    }
    setIsOpening(true);
    setProgress(0);
            ...
            <div className="max-w-7xl w-full grid grid-cols-1 lg:grid-cols-12 gap-10 items-start">
              <div className="lg:col-span-7">
                ...
                <p className="text-[15px] leading-[1.7] text-[#9CA3AF] max-w-[48ch] mb-8">
                  Abre CBZ, PDF, EPUB o imágenes sueltas. Todo se procesa en tu dispositivo, sin subidas. Layouts simple, doble y scroll, más modo manga derecha-a-izquierda.
                </p>
              ...
              <div className="lg:col-span-5">
                <div className="bg-[#1a1a1a] border border-[#2A2E33] rounded-[14px] p-6">
                  <div className="flex items-center justify-between mb-4">
                    ...
                    <span className="text-[11px] text-[#6B7280]">CBZ · PDF · EPUB · IMG</span>
                  </div>
